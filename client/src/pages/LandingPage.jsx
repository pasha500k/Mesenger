        ...
        <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center relative">
          <div>
            ...
            <p className="text-lg text-slate-300 mb-8 leading-relaxed">
              Создавайте комнаты, подключайтесь к защищенным видеозвонкам, делитесь идеями на векторной доске и отправляйте
              файлы команде. Всё работает прямо из браузера.
            </p>
